...
export declare type SiderRenderProps = {
    /**
...
export declare type RefineLayoutSiderProps = {
    Title?: React.FC<TitleProps>;
    render?: (props: SiderRenderProps) => React.ReactNode;
    meta?: Record<string, unknown>;
};
export declare type RefineLayoutHeaderProps = {};
export declare type RefineLayoutFooterProps = {};
export declare type RefineLayoutTitleProps = TitleProps;
export declare type RefineLayoutLayoutProps = LayoutProps;
/**
 ...
 */
export declare type RefineThemedLayoutProps = RefineLayoutLayoutProps;
/**
 * @deprecated It is recommended to use the improved `ThemedLayoutV2`. Review migration guidelines. https://refine.dev/docs/api-reference/mui/components/mui-themed-layout/#migrate-themedlayout-to-themedlayoutv2
 */
export declare type RefineThemedLayoutSiderProps = RefineLayoutSiderProps & {
    isSiderOpen?: boolean;
 ...
 * @deprecated It is recommended to use the improved `ThemedLayoutV2`. Review migration guidelines. https://refine.dev/docs/api-reference/mui/components/mui-themed-layout/#migrate-themedlayout-to-themedlayoutv2
 */
export declare type RefineThemedLayoutHeaderProps = RefineLayoutHeaderProps & {
    isSiderOpen?: boolean;
    onToggleSiderClick?: (isOpen?: boolean) => void;
    toggleSiderIcon?: (open: boolean) => React.ReactNode;
};
export declare type RefineLayoutThemedTitleProps = RefineLayoutTitleProps & {
    icon?: React.ReactNode;
    text?: React.ReactNode;
    wrapperStyles?: React.CSSProperties;
};
export declare type RefineThemedLayoutV2Props = {
    /**
     * Whether the sider is collapsed or not by default.
     */
    initialSiderCollapsed?: boolean;
} & RefineLayoutLayoutProps;
export declare type RefineThemedLayoutV2SiderProps = RefineLayoutSiderProps & {
    activeItemDisabled?: boolean;
};
export declare type RefineThemedLayoutV2HeaderProps = RefineLayoutHeaderProps & {
    /**
