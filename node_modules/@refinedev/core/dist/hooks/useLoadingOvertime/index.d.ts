export declare type UseLoadingOvertimeRefineContext = Omit<UseLoadingOvertimeCoreProps, "isLoading" | "interval"> & Required<Pick<UseLoadingOvertimeCoreProps, "interval">>;
export declare type UseLoadingOvertimeOptionsProps = {
    overtimeOptions?: UseLoadingOvertimeCoreOptions;
};
export declare type UseLoadingOvertimeReturnType = {
    overtime: {
        elapsedTime?: number;
    };
};
declare type UseLoadingOvertimeCoreOptions = Omit<UseLoadingOvertimeCoreProps, "isLoading">;
declare type UseLoadingOvertimeCoreReturnType = {
    elapsedTime?: number;
};
export declare type UseLoadingOvertimeCoreProps = {
    /**
