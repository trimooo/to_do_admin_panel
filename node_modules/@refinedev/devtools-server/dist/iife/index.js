(()=>{var De=Object.create;var C=Object.defineProperty;var xe=Object.getOwnPropertyDescriptor;var Ce=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,Ne=Object.prototype.hasOwnProperty;var c=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});var Ve=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Ue=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of Ce(t))!Ne.call(e,i)&&i!==r&&C(e,i,{get:()=>t[i],enumerable:!(n=xe(t,i))||n.enumerable});return e};var d=(e,t,r)=>(r=e!=null?De(je(e)):{},Ue(t||!e||!e.__esModule?C(r,"default",{value:e,enumerable:!0}):r,e));var y=Ve((dt,$)=>{"use client";var Fe=Object.create,_=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,He=Object.getOwnPropertyNames,$e=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty,Ge=(e,t)=>{for(var r in t)_(e,r,{get:t[r],enumerable:!0})},j=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of He(t))!We.call(e,i)&&i!==r&&_(e,i,{get:()=>t[i],enumerable:!(n=Me(t,i))||n.enumerable});return e},Je=(e,t,r)=>(r=e!=null?Fe($e(e)):{},j(t||!e||!e.__esModule?_(r,"default",{value:e,enumerable:!0}):r,e)),qe=e=>j(_({},"__esModule",{value:!0}),e),N={};Ge(N,{DevToolsContext:()=>H,DevToolsContextProvider:()=>Ke,DevtoolsEvent:()=>V,hooksByScope:()=>Be,receive:()=>M,scopes:()=>U,send:()=>F});$.exports=qe(N);var V=(e=>(e.RELOAD="devtools:reload",e.DEVTOOLS_INIT="devtools:init",e.DEVTOOLS_HANDSHAKE="devtools:handshake",e.DEVTOOLS_ALREADY_CONNECTED="devtools:already-connected",e.ACTIVITY="devtools:send-activity",e.DEVTOOLS_ACTIVITY_UPDATE="devtools:activity-update",e.DEVTOOLS_CONNECTED_APP="devtools:connected-app",e.DEVTOOLS_DISCONNECTED_APP="devtools:disconnected-app",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR="devtools:highlight-in-monitor",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR_ACTION="devtools:highlight-in-monitor-action",e.DEVTOOLS_LOGIN_SUCCESS="devtools:login-success",e.DEVTOOLS_RELOAD_AFTER_LOGIN="devtools:reload-after-login",e))(V||{}),U={useCan:"access-control",useLog:"audit-log",useLogList:"audit-log",useCreate:"data",useCreateMany:"data",useCustom:"data",useCustomMutation:"data",useDelete:"data",useDeleteMany:"data",useInfiniteList:"data",useList:"data",useMany:"data",useOne:"data",useUpdate:"data",useUpdateMany:"data",useForgotPassword:"auth",useGetIdentity:"auth",useIsAuthenticated:"auth",useLogin:"auth",useLogout:"auth",useOnError:"auth",usePermissions:"auth",useRegister:"auth",useUpdatePassword:"auth"},Be=Object.entries(U).reduce((e,[t,r])=>(e[r]||(e[r]=[]),e[r].push(t),e),{}),v=Je(c("react"));async function F(e,t,r){if(e.readyState!==e.OPEN){await new Promise(n=>{let i=()=>{e.send(JSON.stringify({event:t,payload:r})),n(),e.removeEventListener("open",i)};e.addEventListener("open",i)});return}e.send(JSON.stringify({event:t,payload:r}))}function M(e,t,r){let n=i=>{let{event:a,payload:s}=JSON.parse(i.data);t===a&&r(s)};return e.addEventListener("message",n),()=>{e.removeEventListener("message",n)}}var H=v.default.createContext({__devtools:!1,port:5002,url:"localhost",secure:!1,ws:null}),Ke=({__devtools:e,port:t,children:r})=>{let[n,i]=v.default.useState({__devtools:e??!1,port:t??5002,url:"localhost",secure:!1,ws:null}),[a,s]=v.default.useState(null);v.default.useEffect(()=>{let l=new WebSocket(`${n.secure?"wss":"ws"}://localhost:${n.port}`),u=M(l,"devtools:handshake",L=>{i(P=>({...P,devtoolsUrl:L.url})),u()});return l.addEventListener("open",()=>{n.__devtools||F(l,"devtools:init",{url:window.location.origin})}),s(l),()=>{u(),l.close(1e3,window.location.origin)}},[]);let o=v.default.useMemo(()=>({...n,ws:a}),[n,a]);return v.default.createElement(H.Provider,{value:o},r)}});var be=d(c("express")),p=d(y());var W=d(c("express")),b=d(c("path")),G=e=>{e.use(W.default.static(b.default.join(__dirname,"client"))),e.use((t,r,n)=>{if(t.path.startsWith("/api")||t.path.startsWith("/open-in-editor"))return n();r.status(200).sendFile(b.default.join(`${__dirname}/client/index.html`))})};var q=d(c("ws"));var E="https://cloud2.refine.dev",J="https://raw.githubusercontent.com/refinedev/refine/master/packages/devtools-server/FEED.md";var A=d(y()),g=c("chalk"),B=()=>{let e=new q.default.Server({port:5002}).on("error",t=>{(t==null?void 0:t.code)==="EADDRINUSE"?console.error(`
